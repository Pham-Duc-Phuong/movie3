  ...
  return (
    <div className='h-screen'>
      <div className='w-bookingX h-bookingY bg-white translate-x-bookingX translate-y-bookingY rounded-lg flex flex-col justify-center items-center'>
        ...
        <p className='text-4xl font-500 text-blue-700 text-center leading-normal my-50'>Khách hàng có thể xem phim trực tuyến tại <a className='underline text-red-500' href="https://vlxx.moe/"> phimmoi.net</a></p>
      </div>
    </div>
  )
}
