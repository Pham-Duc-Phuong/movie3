      ...
      <div className="translate-x-detailmovieX translate-y-detailmovieY flex items-center  w-detailmovie h-detailmovie bg-white border border-gray-200 rounded-lg shadow md:flex-row dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
        ...
        <div className="p-4 leading-normal h-imageA">
          ...
          <div className="relative overflow-x-auto ">
            ...
            <div className='mb-24'>
              <a href={detailMovie.trailer} target='_blank'><button className="inline-flex items-center p-8 pl-14 pr-14 mr-28 text-20 font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
              >
                Trailer
              </button></a>
